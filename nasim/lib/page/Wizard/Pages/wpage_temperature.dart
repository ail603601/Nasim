...
class wpage_temperatureState extends State<wpage_temperature> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    widget.Next = () {
      ...
      // if (_tabController!.index == 0) {
      //   if (!is_day_set) {
      //     Utils.alert(context, "", "Please Apply Day time Temperature.");
      //     return false;
      //   }
      //   _tabController!.animateTo(1);
      ...
      //   }
      //   if (!is_night_set) {
      //     Utils.alert(context, "", "Please Apply night time Temperature.");
      //     return false;
      //   }
      //   return true;
      // }
  ...
  Widget row_room_temp() {
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(child: Text("Desired Temperature:")),
          Expanded(
            child: TextField(
  ...
  Widget row_room_temp_sensivity() {
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(child: Text("Desired Temp Sensitivity:")),
          Expanded(
            child: TextField(
